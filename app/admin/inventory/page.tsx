  ...
  return (
    <main className="min-h-screen bg-slate-50 p-4 md:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <header><p className="text-sm font-black uppercase text-slate-500">Controlled Stock Ledger</p><h1 className="text-3xl font-black">Inventory Adjustments</h1></header>
        <form action={adjustInventory} className="grid gap-4 rounded-lg bg-white p-5 shadow-sm md:grid-cols-2">
          ...
          <button className="h-12 rounded bg-slate-950 font-black text-white md:col-span-2">Record Audited Adjustment</button>
        </form>
