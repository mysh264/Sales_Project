...
export default function LoginPage() {
  return (
    <div className="relative min-h-screen bg-app-bg">
      {/* Top-right floating "View Presentation" link. Absolute so it sits
          above the centered card without shifting the card's vertical
          center. pointer-events-auto on a non-interactive parent is the
          default, so the link is always clickable. */}
